      ...
      <div className="flex cursor-default flex-col items-center justify-center">
        <div className="relative isolate flex h-128 w-lg flex-col items-center justify-center gap-6 overflow-hidden rounded-2xl border border-gray-300 bg-[url('/bgs/frame1.svg')] bg-repeat shadow-2xl">
          ...
          <div className="absolute z-20 h-80 w-80">
            <div className="absolute top-6 -right-15 flex items-center gap-2 rounded-lg border border-gray-300 bg-white p-1 px-2 text-center text-sm font-bold shadow-xl delay-50 duration-200 ease-in-out hover:scale-110">
              <Globe />
              PROXIMIDADE <br />
              SEMÂNTICA
            </div>
            <div className="absolute bottom-15 -left-15 flex items-center gap-2 rounded-lg border border-gray-300 bg-white p-1 px-2 text-center text-sm font-bold shadow-xl delay-50 duration-200 ease-in-out hover:scale-110">
