...
export default function About() {
  return (
    <div className="mb-24 flex w-full flex-col items-center text-center">
      <h1 className="text-center text-4xl font-bold">
        O que é o Sentence Space?
      </h1>
      <div className="mt-2 flex w-1/2 flex-col gap-10 text-justify">
        <section>
          <p>
            Sentence Space é um experimento/ferramenta que transforma frases em
            vetores e as mostra num espaço visual para você ver, explorar e
        ...
        <section className={styles.section}>
          ...
          <div className="mt-2 flex flex-col items-center">
            <ol className="w-[95%] list-inside list-decimal space-y-2 marker:font-bold">
              ...
              <li>
                <span>Redução (UMAP):</span> esses vetores de alta dimensão são
                projetados em 2 dimensões por UMAP, preservando relações
                semânticas locais.
              </li>
              <li>
        ...
        <section className={styles.section}>
          ...
          <div className="mt-2 flex flex-col items-center">
            <ul className="w-[95%] list-inside list-disc space-y-2">
              ...
              <li>
                <span>Aprendizado e diagnóstico:</span> ajuda a entender modelos
                de linguagem, clusters semânticos e possíveis vieses
              </li>
              <li>
                <span>Protótipo prático:</span> inspiração direta de como
                embeddings são usados em chatbots e bancos vetoriais para busca
                por similaridade.
              </li>
            </ul>
          </div>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            chatbots e bancos de dados vetoriais. Durante um projeto de extensão
            no PET-Saúde, precisei implementar um conjunto de FAQs em um banco
            de dados vetorial para alimentar um chatbot — e foi nesse processo
            que a intuição por trás dos embeddings se tornou concreta: frases
            com significados próximos ocupam regiões próximas no espaço
            vetorial. Explicações didáticas normalmente ilustram isso com frases
            em um plano cartesiano; o Sentence Space é a versão prática e
            interativa dessa ideia.
          </p>
        </section>
      </div>
    </div>
